...
DROP DATABASE IF EXISTS `bookstore_clone`;
CREATE DATABASE IF NOT EXISTS `bookstore_clone` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_polish_ci */;
USE `bookstore_clone`;
...
INSERT INTO `books` (`book_id`, `name`, `release_date`, `format_id`) VALUES
	...
	(2, 'We\'re All Damaged and Life', NULL, NULL),
...
INSERT INTO `books_opinions` (`opinion_id`, `book_id`, `opinion`, `author`) VALUES
	...
	(2, 2, 'One of the best-written books I\'ve come across in many years. Its amazing how 3 major dev environments could be covered so thoroughly in 1 book', 'Mike'),
